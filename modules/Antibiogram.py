...
class Antibiogram(GISMOH_Object):
    ...
    @staticmethod
    def find(store, isolate_id, date):
...
class AntibiogramIdentifier(GISMOH_Object):
    identifier = ''
    sir_results = {}
        
class AntibiogramInterface(object):
    ...
    def get_nearest(self, ab1, n = None, cutoff = 1.0, mismatch_penalty = 1.0, gap_penalty = 0.5):
        ...
        for ab2 in Antibiogram.get_by(self.store, 'is_resistant', True):
